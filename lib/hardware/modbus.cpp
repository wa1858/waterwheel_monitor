...
{
    Modbus::Modbus(int port_number, utils::Logger &logger_) : logger(logger_)
    {
    ...
    Modbus::~Modbus()
    {
        ...
        this->logger.log(utils::LogLevel::debug, "Serial connection closed");
    }
    ...
    HANDLE Modbus::setupSerial(int port_number)
    {
        ...
        logger.log(utils::LogLevel::info, "Opening serial port COM%d", port_number);
