...
//     int wideStrLen = MultiByteToWideChar(CP_UTF8, 0, port.c_str(), -1, nullptr, 0);

//     // Allocate memory for the wide-character string
//     wchar_t *wideStr = new wchar_t[wideStrLen];

//     // Convert the multibyte string to a wide-character string
//     MultiByteToWideChar(CP_UTF8, 0, port.c_str(), -1, wideStr, wideStrLen);

//     HANDLE hSerial = CreateFile(
//         wideStr, GENERIC_READ | GENERIC_WRITE, 0, nullptr,
